...
(* CORE_GENERATION_INFO="trace_cntrl_32,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.404000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=887,HLS_SYN_LUT=850}" *)
...
reg   [31:0] length_read_reg_256;
reg   [31:0] data_compare_V_read_reg_261;
wire   [31:0] tmp_fu_149_p2;
reg   [31:0] tmp_reg_267;
reg   [31:0] i_load_reg_272;
wire    ap_block_state2_pp0_stage0_iter0;
wire    ap_block_state4_pp0_stage0_iter1;
reg    ap_block_state4_io;
reg    ap_block_pp0_stage0_flag00011001;
wire   [0:0] tmp_1_fu_168_p2;
reg   [0:0] ap_reg_pp0_iter1_tmp_1_reg_277;
reg   [31:0] A_temp_data_V_reg_281;
reg    ap_block_state3_pp0_stage1_iter0;
wire    ap_block_state5_pp0_stage1_iter1;
reg    ap_block_state5_io;
reg    ap_block_pp0_stage1_flag00011001;
reg   [3:0] A_temp_keep_V_reg_286;
reg   [3:0] A_temp_strb_V_reg_291;
reg   [0:0] A_temp_user_V_reg_296;
reg   [0:0] A_temp_id_V_reg_301;
reg   [0:0] A_temp_dest_V_reg_306;
wire   [0:0] tmp_5_fu_207_p2;
wire   [0:0] A_temp_last_V_fu_216_p2;
reg   [0:0] A_temp_last_V_reg_316;
reg    ap_block_pp0_stage0_flag00011011;
reg    ap_condition_pp0_exit_iter0_state2;
reg    ap_block_pp0_stage1_flag00011011;
reg   [0:0] match_phi_fu_141_p4;
reg   [31:0] samples_fu_74;
wire   [31:0] samples_1_fu_221_p2;
reg   [31:0] i_fu_78;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b1 == ap_enable_reg_pp0_iter0) & (1'd1 == tmp_1_reg_277) & (ap_block_pp0_stage1_flag00011001 == 1'b0) & (1'd1 == tmp_5_fu_207_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage1_flag00011001 == 1'b0) & (1'd1 == ap_reg_pp0_iter1_tmp_1_reg_277))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'd1 == tmp_1_reg_277) & (ap_block_pp0_stage1_flag00011001 == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'd1 == tmp_1_reg_277) & (ap_block_pp0_stage1_flag00011001 == 1'b0) & (1'd1 == tmp_5_fu_207_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b1 == ap_enable_reg_pp0_iter0) & (1'd1 == tmp_1_reg_277) & (ap_block_pp0_stage1_flag00011001 == 1'b0))) begin
        tmp_5_reg_311 <= tmp_5_fu_207_p2;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage1_flag00000000 == 1'b0) & (1'd1 == tmp_1_reg_277))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'd1 == tmp_5_reg_311)) | ((1'b1 == ap_CS_fsm_pp0_stage1) & (ap_block_pp0_stage1_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'd1 == tmp_5_reg_311)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'd1 == tmp_5_reg_311) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (ap_block_pp0_stage1_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'd1 == ap_reg_pp0_iter1_tmp_1_reg_277))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (((ap_block_pp0_stage0_flag00011011 == 1'b0) & ~((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'd0 == tmp_1_fu_168_p2) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage1;
            end else if (((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'd0 == tmp_1_fu_168_p2) & (ap_enable_reg_pp0_iter1 == 1'b0))) begin
...
assign A_temp_last_V_fu_216_p2 = ((samples_fu_74 == tmp_reg_267) ? 1'b1 : 1'b0);
...
always @ (*) begin
    ap_block_pp0_stage1_flag00001001 = ((1'b1 == ap_enable_reg_pp0_iter0) & (1'd1 == tmp_1_reg_277) & (1'b0 == A_data_V_0_vld_out));
end

always @ (*) begin
    ap_block_pp0_stage1_flag00011001 = (((1'b1 == ap_enable_reg_pp0_iter0) & (1'd1 == tmp_1_reg_277) & (1'b0 == A_data_V_0_vld_out)) | ((1'b1 == ap_enable_reg_pp0_iter1) & (1'b1 == ap_block_state5_io)));
end

always @ (*) begin
    ap_block_pp0_stage1_flag00011011 = (((1'b1 == ap_enable_reg_pp0_iter0) & (1'd1 == tmp_1_reg_277) & (1'b0 == A_data_V_0_vld_out)) | ((1'b1 == ap_enable_reg_pp0_iter1) & (1'b1 == ap_block_state5_io)));
end

assign ap_block_state2_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_pp0_stage1_iter0 = ((1'd1 == tmp_1_reg_277) & (1'b0 == A_data_V_0_vld_out));
end

always @ (*) begin
    ap_block_state4_io = ((1'd1 == tmp_5_reg_311) & (1'b0 == B_data_V_1_ack_in));
end

assign ap_block_state4_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state5_io = ((1'd1 == tmp_5_reg_311) & (1'b0 == B_data_V_1_ack_in));
end
...
assign i_1_fu_227_p2 = (i_load_reg_272 + 32'd1);

assign samples_1_fu_221_p2 = (samples_fu_74 + 32'd1);

assign tmp_1_fu_168_p2 = (($signed(i_fu_78) < $signed(length_read_reg_256)) ? 1'b1 : 1'b0);

assign tmp_3_fu_197_p2 = (A_data_V_0_data_out & data_compare_V_read_reg_261);

assign tmp_4_fu_202_p2 = ((tmp_3_fu_197_p2 == data_compare_V_read_reg_261) ? 1'b1 : 1'b0);

assign tmp_5_fu_207_p2 = (tmp_4_fu_202_p2 | match_phi_fu_141_p4);

assign tmp_fu_149_p2 = ($signed(length_r) + $signed(32'd4294967295));
