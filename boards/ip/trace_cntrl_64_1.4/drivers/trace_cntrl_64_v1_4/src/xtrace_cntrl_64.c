...
void XTrace_cntrl_64_Set_data_compare_V(XTrace_cntrl_64 *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XTrace_cntrl_64_WriteReg(InstancePtr->Trace_cntrl_BaseAddress, XTRACE_CNTRL_64_TRACE_CNTRL_ADDR_DATA_COMPARE_V_DATA, (u32)(Data));
    XTrace_cntrl_64_WriteReg(InstancePtr->Trace_cntrl_BaseAddress, XTRACE_CNTRL_64_TRACE_CNTRL_ADDR_DATA_COMPARE_V_DATA + 4, (u32)(Data >> 32));
}

u64 XTrace_cntrl_64_Get_data_compare_V(XTrace_cntrl_64 *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XTrace_cntrl_64_ReadReg(InstancePtr->Trace_cntrl_BaseAddress, XTRACE_CNTRL_64_TRACE_CNTRL_ADDR_DATA_COMPARE_V_DATA);
    Data += (u64)XTrace_cntrl_64_ReadReg(InstancePtr->Trace_cntrl_BaseAddress, XTRACE_CNTRL_64_TRACE_CNTRL_ADDR_DATA_COMPARE_V_DATA + 4) << 32;
    return Data;
}
