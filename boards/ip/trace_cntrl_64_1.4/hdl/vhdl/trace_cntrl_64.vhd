...
architecture behav of trace_cntrl_64 is 
    ...
    "trace_cntrl_64,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.404000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1119,HLS_SYN_LUT=914}";
    ...
    signal A_data_V_0_data_out : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal A_data_V_0_payload_A : STD_LOGIC_VECTOR (63 downto 0);
    signal A_data_V_0_payload_B : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal A_keep_V_0_data_out : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal A_keep_V_0_payload_A : STD_LOGIC_VECTOR (7 downto 0);
    signal A_keep_V_0_payload_B : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal A_strb_V_0_data_out : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal A_strb_V_0_payload_A : STD_LOGIC_VECTOR (7 downto 0);
    signal A_strb_V_0_payload_B : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal B_data_V_1_data_out : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal B_data_V_1_payload_A : STD_LOGIC_VECTOR (63 downto 0);
    signal B_data_V_1_payload_B : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal B_keep_V_1_data_out : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal B_keep_V_1_payload_A : STD_LOGIC_VECTOR (7 downto 0);
    signal B_keep_V_1_payload_B : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal B_strb_V_1_data_out : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal B_strb_V_1_payload_A : STD_LOGIC_VECTOR (7 downto 0);
    signal B_strb_V_1_payload_B : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_7_reg_321 : STD_LOGIC_VECTOR (0 downto 0);
    signal match_reg_139 : STD_LOGIC_VECTOR (0 downto 0);
    signal length_read_reg_266 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_fu_151_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_reg_271 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_fu_157_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_reg_276 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_load_reg_282 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state2_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state4_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state4_io : BOOLEAN;
    signal ap_block_pp0_stage0_flag00011001 : BOOLEAN;
    signal tmp_1_fu_174_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_reg_pp0_iter1_tmp_1_reg_287 : STD_LOGIC_VECTOR (0 downto 0);
    signal A_temp_data_V_reg_291 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state3_pp0_stage1_iter0 : BOOLEAN;
    signal ap_block_state5_pp0_stage1_iter1 : BOOLEAN;
    signal ap_block_state5_io : BOOLEAN;
    signal ap_block_pp0_stage1_flag00011001 : BOOLEAN;
    signal A_temp_keep_V_reg_296 : STD_LOGIC_VECTOR (7 downto 0);
    signal A_temp_strb_V_reg_301 : STD_LOGIC_VECTOR (7 downto 0);
    signal A_temp_user_V_reg_306 : STD_LOGIC_VECTOR (0 downto 0);
    signal A_temp_id_V_reg_311 : STD_LOGIC_VECTOR (0 downto 0);
    signal A_temp_dest_V_reg_316 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_7_fu_217_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal A_temp_last_V_fu_226_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal A_temp_last_V_reg_326 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_flag00011011 : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state2 : STD_LOGIC;
    signal ap_block_pp0_stage1_flag00011011 : BOOLEAN;
    signal match_phi_fu_143_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal samples_fu_76 : STD_LOGIC_VECTOR (31 downto 0);
    signal samples_1_fu_231_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_80 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_1_fu_237_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_flag00001001 : BOOLEAN;
    signal ap_block_pp0_stage1_flag00001001 : BOOLEAN;
    signal tmp_3_fu_203_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_5_fu_207_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_fu_212_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_block_pp0_stage1_flag00011001 = ap_const_boolean_0) and (ap_const_lv1_1 = tmp_7_fu_217_p2))) then 
                i_fu_80 <= i_1_fu_237_p2;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
                i_fu_80 <= ap_const_lv32_0;
            end if; 
        end if;
    end process;

    match_reg_139_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage1_flag00011001 = ap_const_boolean_0) and (ap_const_lv1_1 = ap_reg_pp0_iter1_tmp_1_reg_287))) then 
                match_reg_139 <= tmp_7_reg_321;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
                match_reg_139 <= ap_const_lv1_0;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_block_pp0_stage1_flag00011001 = ap_const_boolean_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_block_pp0_stage1_flag00011001 = ap_const_boolean_0) and (ap_const_lv1_1 = tmp_7_fu_217_p2))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_block_pp0_stage1_flag00011001 = ap_const_boolean_0))) then
                tmp_7_reg_321 <= tmp_7_fu_217_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, B_data_V_1_ack_in, B_keep_V_1_ack_in, B_strb_V_1_ack_in, B_user_V_1_ack_in, B_last_V_1_ack_in, B_id_V_1_ack_in, B_dest_V_1_ack_in, ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, tmp_1_fu_174_p2, ap_block_pp0_stage0_flag00011011, ap_block_pp0_stage1_flag00011011, ap_CS_fsm_state6)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if (((ap_block_pp0_stage0_flag00011011 = ap_const_boolean_0) and not(((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_block_pp0_stage0_flag00011011 = ap_const_boolean_0) and (ap_const_lv1_0 = tmp_1_fu_174_p2) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage1;
                elsif (((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_block_pp0_stage0_flag00011011 = ap_const_boolean_0) and (ap_const_lv1_0 = tmp_1_fu_174_p2) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))) then
    ...
    A_TDATA_blk_n_assign_proc : process(A_data_V_0_state, ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_block_pp0_stage1_flag00000000, tmp_1_reg_287)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_block_pp0_stage1_flag00000000 = ap_const_boolean_0) and (ap_const_lv1_1 = tmp_1_reg_287))) then 
    ...
    A_data_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, tmp_1_reg_287, ap_block_pp0_stage1_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_block_pp0_stage1_flag00011001 = ap_const_boolean_0))) then 
    ...
    A_dest_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, tmp_1_reg_287, ap_block_pp0_stage1_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_block_pp0_stage1_flag00011001 = ap_const_boolean_0))) then 
    ...
    A_id_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, tmp_1_reg_287, ap_block_pp0_stage1_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_block_pp0_stage1_flag00011001 = ap_const_boolean_0))) then 
    ...
    A_keep_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, tmp_1_reg_287, ap_block_pp0_stage1_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_block_pp0_stage1_flag00011001 = ap_const_boolean_0))) then 
    ...
    A_strb_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, tmp_1_reg_287, ap_block_pp0_stage1_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_block_pp0_stage1_flag00011001 = ap_const_boolean_0))) then 
    ...
    A_temp_last_V_fu_226_p2 <= "1" when (samples_fu_76 = tmp_reg_271) else "0";
    A_user_V_0_ack_in <= A_user_V_0_state(1);

    A_user_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, tmp_1_reg_287, ap_block_pp0_stage1_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_block_pp0_stage1_flag00011001 = ap_const_boolean_0))) then 
    ...
    B_TDATA_blk_n_assign_proc : process(B_data_V_1_state, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_flag00000000, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00000000, tmp_7_reg_321)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_block_pp0_stage0_flag00000000 = ap_const_boolean_0) and (ap_const_lv1_1 = tmp_7_reg_321)) or ((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_block_pp0_stage1_flag00000000 = ap_const_boolean_0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_1 = tmp_7_reg_321)))) then 
    ...
    B_data_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_7_reg_321, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_1 = tmp_7_reg_321) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    B_dest_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_7_reg_321, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_1 = tmp_7_reg_321) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    B_id_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_7_reg_321, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_1 = tmp_7_reg_321) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    B_keep_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_7_reg_321, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_1 = tmp_7_reg_321) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    B_last_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_7_reg_321, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_1 = tmp_7_reg_321) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    B_strb_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_7_reg_321, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_1 = tmp_7_reg_321) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    B_user_V_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_7_reg_321, ap_block_pp0_stage0_flag00011001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_1 = tmp_7_reg_321) and (ap_block_pp0_stage0_flag00011001 = ap_const_boolean_0))) then 
    ...
    ap_block_pp0_stage1_flag00001001_assign_proc : process(A_data_V_0_vld_out, ap_enable_reg_pp0_iter0, tmp_1_reg_287)
    begin
                ap_block_pp0_stage1_flag00001001 <= ((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_const_logic_0 = A_data_V_0_vld_out));
    end process;


    ap_block_pp0_stage1_flag00011001_assign_proc : process(A_data_V_0_vld_out, ap_enable_reg_pp0_iter0, tmp_1_reg_287, ap_enable_reg_pp0_iter1, ap_block_state5_io)
    begin
                ap_block_pp0_stage1_flag00011001 <= (((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_const_logic_0 = A_data_V_0_vld_out)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_boolean_1 = ap_block_state5_io)));
    end process;


    ap_block_pp0_stage1_flag00011011_assign_proc : process(A_data_V_0_vld_out, ap_enable_reg_pp0_iter0, tmp_1_reg_287, ap_enable_reg_pp0_iter1, ap_block_state5_io)
    begin
                ap_block_pp0_stage1_flag00011011 <= (((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_const_lv1_1 = tmp_1_reg_287) and (ap_const_logic_0 = A_data_V_0_vld_out)) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_boolean_1 = ap_block_state5_io)));
    end process;

        ap_block_state2_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state3_pp0_stage1_iter0_assign_proc : process(A_data_V_0_vld_out, tmp_1_reg_287)
    begin
                ap_block_state3_pp0_stage1_iter0 <= ((ap_const_lv1_1 = tmp_1_reg_287) and (ap_const_logic_0 = A_data_V_0_vld_out));
    end process;


    ap_block_state4_io_assign_proc : process(B_data_V_1_ack_in, tmp_7_reg_321)
    begin
                ap_block_state4_io <= ((ap_const_lv1_1 = tmp_7_reg_321) and (ap_const_logic_0 = B_data_V_1_ack_in));
    end process;

        ap_block_state4_pp0_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state5_io_assign_proc : process(B_data_V_1_ack_in, tmp_7_reg_321)
    begin
                ap_block_state5_io <= ((ap_const_lv1_1 = tmp_7_reg_321) and (ap_const_logic_0 = B_data_V_1_ack_in));
    end process;
    ...
    ap_condition_pp0_exit_iter0_state2_assign_proc : process(tmp_1_fu_174_p2)
    begin
        if ((ap_const_lv1_0 = tmp_1_fu_174_p2)) then 
    ...
    i_1_fu_237_p2 <= std_logic_vector(unsigned(i_load_reg_282) + unsigned(ap_const_lv32_1));

    match_phi_fu_143_p4_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_flag00000000, ap_enable_reg_pp0_iter1, tmp_7_reg_321, match_reg_139, ap_reg_pp0_iter1_tmp_1_reg_287)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_block_pp0_stage1_flag00000000 = ap_const_boolean_0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_lv1_1 = ap_reg_pp0_iter1_tmp_1_reg_287))) then 
    ...
    samples_1_fu_231_p2 <= std_logic_vector(unsigned(samples_fu_76) + unsigned(ap_const_lv32_1));
    tmp_1_fu_174_p2 <= "1" when (signed(i_fu_80) < signed(length_read_reg_266)) else "0";
    tmp_2_fu_157_p1 <= data_compare_V(32 - 1 downto 0);
    tmp_3_fu_203_p1 <= A_data_V_0_data_out(32 - 1 downto 0);
    tmp_5_fu_207_p2 <= (tmp_2_reg_276 and tmp_3_fu_203_p1);
    tmp_6_fu_212_p2 <= "1" when (tmp_5_fu_207_p2 = tmp_2_reg_276) else "0";
    tmp_7_fu_217_p2 <= (tmp_6_fu_212_p2 or match_phi_fu_143_p4);
    tmp_fu_151_p2 <= std_logic_vector(signed(ap_const_lv32_FFFFFFFF) + signed(length_r));
end behav;
